...
public class MapPractice {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1. Display each Java topic and its hours on the console");
        ...
        System.out.println("2. Display the names of the java topics that we spend more than 7 hours");
        for (Map<String, Double> eachUnit : allUnits) {
        ...
        System.out.println("3. Display the names of the java topics that we spend less than 3 hours");
        for (Map<String, Double> eachUnit : allUnits) {
        ...
        System.out.println("4. Which Java Topic has the maximum hours?");
        System.out.println("name1 = " + name1);
        System.out.println("max = " + max);
        System.out.println("---------------------------------------------------");
        System.out.println("5. Which topic has the minimum hours?");
