...
import day37_Inheritance.day43_Abstraction.employeeTask.Developer;
import day37_Inheritance.day43_Abstraction.employeeTask.Employee;
...
public class EmployeeTask {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Tester with Maximum Salary is --->>> " + a);


        //2.5 which developer has the maximum salary?

        maxSalary = developers.get(0).getSalary();
        a = "";
        ...
        System.out.println("maxSalary = " + maxSalary);
        System.out.println("Developer with Maximum Salary is --->>> " + a);
