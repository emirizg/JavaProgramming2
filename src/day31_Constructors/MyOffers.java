...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        localOffers.removeIf(p -> !(p.location.equals("VA") || p.location.equals("CA"))); // removes the offe if the offer is not from local
        ...
        //Create an ArrayList of Offer named sdetOffers and add all the offer objects.
