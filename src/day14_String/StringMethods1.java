...
public class StringMethods1 {
    ...
    public static void main(String[] args) {
        ...
        int n5=str3.lastIndexOf("g"); // it is starting from right to left --> it is opposite of indexOf() method
        System.out.println("n5 = " + n5);

        System.out.println("------------------------");

        String s="Java Nova Cava Wawa orange";
        int firstA=s.indexOf("a"); // starting from left to right
        int lastA=s.lastIndexOf("a"); // starting from right to left
