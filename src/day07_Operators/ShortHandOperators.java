...
public class ShortHandOperators {
    ...
    public static void main(String[] args){
        ...
        word="Cydeo";
        System.out.println("word = " + word); // cydeo: reassign-riassegnare

        // word=123; --> Cannot assign this
        ...
        // deposit 300$
        availableBalance+=300; // avaliableBalance = 1000.50 + 300;
        System.out.println("availableBalance = " + availableBalance); //1300.50

        System.out.println("---------------------------------------------");

        // withdrawing 500$
        availableBalance -= 500; // avaliableBalance = 1300.50 - 500;
